...
public class GrafanaDockerComposeIT {
    ...
    public void testGrafanaDashboards() {
        given()
                ...
                .then()
                .statusCode(200)
                .body("title", hasItem("dmn-drools-quarkus-metrics:1.7.0-SNAPSHOT - hello - Operational Dashboard"))
                .body("title", hasItem("dmn-drools-quarkus-metrics:1.7.0-SNAPSHOT - LoanEligibility - Domain Dashboard"))
                .body("title", hasItem("dmn-drools-quarkus-metrics:1.7.0-SNAPSHOT - Hello - Domain Dashboard"))
                .body("title", hasItem("dmn-drools-quarkus-metrics:1.7.0-SNAPSHOT - LoanEligibility - Operational Dashboard"));
    }
