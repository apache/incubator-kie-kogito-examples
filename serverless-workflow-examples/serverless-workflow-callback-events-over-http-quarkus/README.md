...
This example consist of a callback state that waits for an event arriving on wait channel. Its action calls an external service which publishes the wait event over HTTP.
