...
public class TokenProvider {
    ...
    @ConfigProperty(name = "org.acme.examples.sw.github.service.app_id")
    String appId;

    @ConfigProperty(name = "org.acme.examples.sw.github.service.key")
    String privateKeyPath;

    @ConfigProperty(name = "org.acme.examples.sw.github.service.installation_id")
    Long installationId;
