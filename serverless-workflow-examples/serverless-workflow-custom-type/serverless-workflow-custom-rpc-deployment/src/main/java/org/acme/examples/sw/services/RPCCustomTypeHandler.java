 ...
 */
package org.acme.examples.sw.services;

import org.acme.examples.sw.custom.RPCCustomWorkItemHandler;
...
public class RPCCustomTypeHandler extends WorkItemTypeHandler{
    ...
    protected <T extends RuleFlowNodeContainerFactory<T, ?>> WorkItemNodeFactory<T> fillWorkItemHandler(Workflow workflow,
        ...
        return node.workName(RPCCustomWorkItemHandler.NAME).metaData(RPCCustomWorkItemHandler.OPERATION, trimCustomOperation(functionDef));
    }
}
