# Kogito Serverless Workflow - Callback Example with Async API

## Description

This example contains a simple workflow service that illustrate callback state usage, using the AsyncAPI.  
...
For Linux and MacOS, run the docker-compose file:
