...
import static org.acme.examples.EventStateTimeoutsClient.CONFIG_KEY;
...
public interface EventStateTimeoutsClient extends WorkflowClient {
    ...
    /**
     * SW id that was configured in the event_state_timeouts.yaml.
     */
    String ID = "eventstatetimeouts";
    String URI = "/" + ID;
