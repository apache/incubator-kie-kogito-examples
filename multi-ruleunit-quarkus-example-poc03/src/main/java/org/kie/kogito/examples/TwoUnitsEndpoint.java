...
public class TwoUnitsEndpoint {
    ...
    @javax.inject.Inject
    RuleUnit<CommonUnit> commonUnit;
    ...
    public List<org.kie.kogito.examples.LoanApplication> executeQuery(org.kie.kogito.examples.CommonUnit unitDTO) {
        // 1. Execute commonUnit
        RuleUnitInstance<CommonUnit> commonUnitInstance = commonUnit.createInstance(unitDTO);
        commonUnitInstance.fire();
        commonUnitInstance.dispose();
