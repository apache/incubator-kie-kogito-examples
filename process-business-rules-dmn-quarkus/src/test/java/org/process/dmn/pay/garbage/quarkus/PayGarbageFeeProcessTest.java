...
public class PayGarbageFeeProcessTest {
    ...
    @Inject
    @Named("org.process.dmn.pay.garbage.quarkus.paygarbagefee")
    ...
    public void testTemporalResidenceInLondonForTwo() {
        ...
        assertTrue(result.toMap().containsKey("fee"), "The result should be stored in the fee variable");
        assertEquals(BigDecimal.valueOf(1325), ((GarbageFee) (result.toMap().get("fee"))).getAmount());
    }
}
