...
[KOGITO-44](https://issues.jboss.org/browse/KOGITO-44) - Multiple human tasks in process cause duplicated REST endpoints
this issue prevents from completing 'ConfrimTravel' user task due to duplicated resource methods

Applies to Kogito 0.1.3 and will be resolved in 0.2.0 
