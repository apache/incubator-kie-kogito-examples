...
### Start Kogito Data Index Service
 ...
 After downloading the runner, create a folder to store the .proto files that will be used by the service. 

 This service works with .proto files that define the data model. Once **Kogito Visa Service** is started, /target/classes/persistence/visaApplication.proto 
 is generated and it has to be copied to the proto files folder.
