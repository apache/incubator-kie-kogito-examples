...
This is a simple workflow that, after started, waits for an event to be published over HTTP.
When the event is received, the workflow prints the event content to the console.
