 ...
 */
package org.acme.dmn.quarkus.tracing;

import java.util.concurrent.CountDownLatch;
import java.util.concurrent.TimeUnit;

import org.acme.dmn.quarkus.tracing.matcher.StringMatchesUUIDPattern;
...
public class LoanEligibilityIT {
    ...
    public void testEvaluateLoanEligibility() throws InterruptedException {
        ...
        given()
                ...
                .then()
                .statusCode(200)
                .header(KOGITO_EXECUTION_ID_HEADER, StringMatchesUUIDPattern.matchesThePatternOfAUUID())
                .body("'Decide'", is(true));
