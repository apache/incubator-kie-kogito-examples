...
import org.acme.flexible.example.model.Comment;
...
public class CommentService {
    ...
    public SupportCase addCustomerComment(SupportCase supportCase, String comment, String author) {
        return addComment(supportCase, author, comment, State.WAITING_FOR_OWNER);
    }

    public SupportCase addSupportComment(SupportCase supportCase, String comment, String author) {
        return addComment(supportCase, author, comment, State.WAITING_FOR_CUSTOMER);
    }
