 ...
 */
@ApplicationScoped
public class CustomWorkItemHandlerConfig extends CachedWorkItemHandlerConfig {
    private static final Logger logger = LoggerFactory.getLogger(CustomWorkItemHandlerConfig.class);
    {
