...
then
    ...
    echo "$KOGITO_EXAMPLE_PERSISTENCE does not exist. Have you compiled Kogito Example project?"
    exit 1
fi
...
then
    ...
    echo "$KOGITO_EXAMPLE_SVG_FOLDER does not exist. Have you compiled Kogito Example project?"
    exit 1
fi
