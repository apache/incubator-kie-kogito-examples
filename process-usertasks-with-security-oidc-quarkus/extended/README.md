...
1. Open a Terminal
2. Go to the process-usertasks-with-security-oidc-quarkus-extended folder at kogito-examples

```bash
cd <path_to_process-usertasks-with-security-oidc-quarkus-extended>/docker-compose
```
...
```sh
mvn clean package
java -jar target/process-usertasks-with-security-oidc-quarkus-extended-runner.jar
```
...
```
./target/process-usertasks-with-security-oidc-quarkus-extended-runner
```
