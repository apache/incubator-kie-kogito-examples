 ...
 */
package org.acme.flexible.example.springboot;
...
import org.acme.tests.KogitoSpringbootApplication;
...
class ServiceDeskProcessTest {
    ...
    private String createSupportCase() {
        ...
        String id = given()
                ...
                .body("supportCase.state", CoreMatchers.is(State.WAITING_FOR_OWNER.name()))
